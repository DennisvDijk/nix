...
```bash
INIT=$(node "/Users/dennisvandijk/.config/opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/dennisvandijk/.config/opencode/get-shit-done/bin/gsd-tools.cjs" commit \
