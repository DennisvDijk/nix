...
```
Agent(
  prompt="Read /Users/dennisvandijk/.config/opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/dennisvandijk/.config/opencode/get-shit-done/templates/SECURITY.md`
