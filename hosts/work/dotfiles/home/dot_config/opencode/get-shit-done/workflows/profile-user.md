...
Key references:
- @/Users/dennisvandijk/.config/opencode/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/dennisvandijk/.config/opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/dennisvandijk/.config/opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/dennisvandijk/.config/opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/dennisvandijk/.config/opencode/get-shit-done/USER-PROFILE.md" "/Users/dennisvandijk/.config/opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/dennisvandijk/.config/opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/dennisvandijk/.config/opencode/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/dennisvandijk/.config/opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/dennisvandijk/.config/opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Users/dennisvandijk/.config/opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/dennisvandijk/.config/opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/dennisvandijk/.config/opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/dennisvandijk/.config/opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/Users/dennisvandijk/.config/opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/dennisvandijk/.config/opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/dennisvandijk/.config/opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /Users/dennisvandijk/.config/opencode/AGENTS.md
```
