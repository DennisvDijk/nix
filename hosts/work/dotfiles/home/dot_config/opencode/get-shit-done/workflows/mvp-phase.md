...
<required_reading>
@/Users/dennisvandijk/.config/opencode/get-shit-done/references/user-story-template.md
@/Users/dennisvandijk/.config/opencode/get-shit-done/references/spidr-splitting.md
@/Users/dennisvandijk/.config/opencode/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/dennisvandijk/.config/opencode/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/dennisvandijk/.config/opencode/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/dennisvandijk/.config/opencode/get-shit-done/references/spidr-splitting.md`. Briefly:
